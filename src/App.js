    ...
    <div className="App">
      <body>
        <header className="App-header">
          ...
          <div class="al-txt hide">
            <h>Alabama</h>
            <p>Number of users in Alabama:</p>
          </div>
          ...
          <svg width="959" height="593">
            <defs>
              <style>
                {`
                  .state { fill:#D0D0D0; }                        /* default color for all states */
                  .borders { stroke:#282c34; stroke-width:1; }    /* color and width of borders between states */
